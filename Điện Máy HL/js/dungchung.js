...
function themVaoGioHang(masp, tensp) {
    ...
    sessionStorage.setItem('auth_back', location.href);
...
function logIn(form) {
    ...
    for (var u of listUser) {
        if (equalUser(newUser, u)) {
            ...
            // nếu đang ở trang đăng nhập riêng
            if (window.location.pathname.includes('dangnhap.html')) {
                var back = sessionStorage.getItem('auth_back') || 'index.html';
                sessionStorage.removeItem('auth_back');

                // đợi alert hiện xong rồi mới chuyển trang
                setTimeout(() => {
...
function signUp(form) {
    ...
    // (tuỳ chọn) nếu bạn có input nhập lại pass trong UI mới: name="rePass"
    if (form.rePass && form.rePass.value && form.rePass.value !== pass) {
    ...
    // Kiểm tra trùng username trong user thường
    for (var u of listUser) {
        if (newUser.username == u.username) {
            alert('Tên đăng nhập đã có người sử dụng !!');
            return false;
        }
        // (tuỳ chọn) chặn trùng email
    ...
    if (typeof addAlertBox === 'function') {
        addAlertBox('Đăng ký thành công! Xin chào ' + newUser.username, '#5f5', '#000', 2000);
    } else {
        alert('Đăng kí thành công, Bạn sẽ được tự động đăng nhập!');
    }

    // ===== NEW: nếu đang ở trang đăng ký riêng thì chuyển trang =====
    var isRegisterPage = window.location.pathname.includes('dangky.html');
    if (isRegisterPage) {
        var back = sessionStorage.getItem('auth_back') || 'index.html';
        sessionStorage.removeItem('auth_back');
    ...
    // ===== Cũ: đăng ký trong popup thì reload =====
    setTimeout(() => {
        location.reload();
    }, 1200);
...
function checkTaiKhoan() {
    if (!getCurrentUser()) {
        sessionStorage.setItem('auth_back', location.href); // nhớ trang đang đứng
        window.location.href = 'dangnhap.html';
        return false; // nếu onclick="return checkTaiKhoan()"
    }
}
...
// Mega menu Danh mục kiểu Điện Máy Xanh
document.addEventListener('click', function (e) {
  const btn = document.getElementById('dmxCatBtn');
  const mega = document.getElementById('dmxMega');
  const close = document.getElementById('dmxClose');
...
function addHeader() {
    ...
    <div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/trangchu.png" alt="Trang chủ Điện Máy HL" title="Trang chủ Điện Máy HL">
            </a>
        </div>
        ...
        <div class="content">
            <div class="search-header">
                ...
                <div class="dmx-cat">
                    <button class="dmx-cat-btn" id="dmxCatBtn" type="button">
                        <i class="fa fa-bars"></i> Danh mục
                    </button>

                    <div class="dmx-mega" id="dmxMega">
                        <div class="dmx-mega-inner">
                            <div class="dmx-left">
                                <div class="dmx-left-title">Danh mục</div>
                                <a class="dmx-left-item active" href="index.html?search=TV">TV</a>
                                <a class="dmx-left-item" href="index.html?search=Tủ%20lạnh">Tủ lạnh</a>
                                <a class="dmx-left-item" href="index.html?search=Máy%20giặt">Máy giặt</a>
                                <a class="dmx-left-item" href="index.html?search=Điều%20hòa">Điều hòa</a>
                                <a class="dmx-left-item" href="index.html?search=Nồi%20chiên">Nồi chiên</a>
                                <a class="dmx-left-item" href="index.html?search=Máy%20lọc">Máy lọc</a>
                                <a class="dmx-left-item" href="index.html?search=Lò%20vi%20sóng">Lò vi sóng</a>
                                <a class="dmx-left-item" href="index.html?search=Bếp%20từ">Bếp từ</a>
                                <a class="dmx-left-item" href="index.html?search=Tủ%20đông">Tủ đông</a>
                            </div>

                            <div class="dmx-right">
                                <div class="dmx-right-head">
                                    <div class="dmx-right-title">CHƯƠNG TRÌNH HOT</div>
                                    <button class="dmx-close" id="dmxClose" type="button">
                                        <i class="fa fa-times"></i>
                                    </button>
                                </div>

                                <div class="dmx-grid">
                                    <a class="dmx-tile" href="index.html?search=moiramat">
                                        <span class="dmx-ico"><i class="fa fa-bolt"></i></span>
                                        <span class="dmx-txt">Mới ra mắt</span>
                                    </a>
                                    <a class="dmx-tile" href="index.html?search=giamgia">
                                        <span class="dmx-ico"><i class="fa fa-tags"></i></span>
                                        <span class="dmx-txt">Giảm giá</span>
                                    </a>
                                    <a class="dmx-tile" href="index.html?search=Samsung">
                                        <span class="dmx-ico"><i class="fa fa-television"></i></span>
                                        <span class="dmx-txt">Samsung</span>
                                    </a>
                                    <a class="dmx-tile" href="index.html?search=LG">
                                        <span class="dmx-ico"><i class="fa fa-television"></i></span>
                                        <span class="dmx-txt">LG</span>
                                    </a>
                                </div>

                                <div class="dmx-brand">
                                    <div class="dmx-brand-title">Hãng nổi bật</div>
                                    <div class="dmx-brand-row">
                                        <a href="index.html?search=Samsung">Samsung</a>
                                        <a href="index.html?search=LG">LG</a>
                                        <a href="index.html?search=Sony">Sony</a>
                                        <a href="index.html?search=Panasonic">Panasonic</a>
                                        <a href="index.html?search=Toshiba">Toshiba</a>
                                        <a href="index.html?search=Electrolux">Electrolux</a>
                                        <a href="index.html?search=Sharp">Sharp</a>
                                        <a href="index.html?search=Aqua">Aqua</a>
                                        <a href="index.html?search=Daikin">Daikin</a>
                                        <a href="index.html?search=Casper">Casper</a>
                                    </div>
                                </div>
...
function addFooter() {
    ...
    <div class="copy-right">
            <span style="color: #eee; font-weight: bold">___</span></p>
    </div>`);
}
            ...
            <div class="tab-content">
                <div id="login">
                    ...
                    <form onsubmit="return logIn(this);">
                        ...
                        <p class="forgot"><a href="quenmatkhau.html" onclick="showTaiKhoan(false);">Quên mật khẩu?</a></p>
